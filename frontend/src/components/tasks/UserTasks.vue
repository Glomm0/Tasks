<template>
    <div class="text-center">
        <div v-if="displayContent">
            ...
            <div class="row">
                <div class="col-8">
                    <Datepicker v-model="date" range multiCalendars autoApply locale="ru" />
                </div>
                <div class="col-4">
            ...
            <div class="container">
                <ul class="list-group">
                    <li class="list-group-item" v-for="task in this.tasks" :key="task">
                        ...
                        <p>Дата назначения: {{ task.task_date }}</p> {{ task.is_done ? "✅" : "❌" }}
                        <div class="row justify-content-end">

                            <div class="col-4">
                                <button v-if="!task.is_done" v-on:click="updateTask(task)"
                                    class="btn btn-secondary">Завершить задачу</button>
                                <button v-else v-on:click="updateTask(task)" class="btn btn-secondary">Сделать
                                    незаверешнной</button>
                            </div>
                            <div class="col-4">
